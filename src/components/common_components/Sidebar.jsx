...
import { BarChart2, DollarSign, Settings, ShoppingBag, ShoppingCart, TrendingUp, Users, Menu } from "lucide-react"; // Corrected import for Menu
...
const SIDEBAR_ITEMS = [
    ...
    { name: "Trainers", icon: Users, color: "#8B5CF6", href: "/trainers" },
    { name: "Payments", icon: DollarSign, color: "#10B981", href: "/payments" },
    { name: "Reports", icon: ShoppingBag, color: "#F59E0B", href: "/reports" },
